        ...
        <div className="content-layout">
            ...
            <div className="main-content">
                ...
                <div className="laws-of-motion">
                    ...
                    <img title="Laws-of-motion" className="law-image" src={require('./images/laws.png')} alt="Newton's Law Of Motion" />
                    ...
                    <img title="First Law of Motion" className="law-image" src={require('./images/first-law.png')} alt="Newton's First Law Of Motion" />
                    ...
                    <img title="Newton's Second Law" className="law-image" src={require('./images/second-law.png')} alt="Newton's Second Law of Motion" />
